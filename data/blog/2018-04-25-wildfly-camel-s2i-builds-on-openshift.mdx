...
![WildFly Camel S2I](/static/images/wfc-openshift.png)

Fill out the template parameters and click finish to start the S2I build.

![WildFly Camel S2I Build](/static/images/wfc-build-openshift.png)

When the build completes successfully you will see a running pod.

![WildFly Camel S2I Running Pod](/static/images/wfc-pod-openshift.png)
