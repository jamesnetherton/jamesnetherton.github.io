...
In this post we look at how we create integration tests and component documentation for the WildFly Camel subsystem. In [part 1](/blog/2017-09-25-adding-a-new-component-to-the-wildfly-camel-subsystem-part1) we got to the point where we had successfully created some JBoss Modules XML definitions.
