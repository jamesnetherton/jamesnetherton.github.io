...
![Spring Boot Health](/static/images/spring-boot-health.png)
...
![Spring Boot Loggers](/static/images/spring-boot-loggers.png)
...
![Spring Boot HTTP Traces](/static/images/spring-boot-trace.png)
