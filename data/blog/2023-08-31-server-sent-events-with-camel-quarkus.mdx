...
At present, there is no dedicated SSE Camel component, so upvote [CAMEL-16431](https://issues.apache.org/jira/browse/CAMEL-16431) if you're interested. However, frameworks like Quarkus
...
* [Camel Quarkus Micrometer](https://camel.apache.org/camel-quarkus/next/reference/extensions/micrometer.html) for runtime metrics
...
`MetricsService` obtains metrics from the Micrometer `MeterRegistry`. For example, to get the system CPU usage.
